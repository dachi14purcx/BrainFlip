  ...
  return (
    <div className='flex flex-col items-center justify-around h-screen'>
        ...
        <div className='flex flex-col items-center justify-around h-[600px]'>
            <div className='flex items-center absolute top-60 loading'>
                    <div>
                        <div className='w-[100px] h-[100px] rounded-xs mb-7 start origin-bottom-lef rotated'></div>
                        <div className='w-[100px] h-[100px] rounded-xs bg-white'></div>
                    </div>
                    

                    <div className='ml-7 opener'>
                        <div className='w-[100px] h-[100px] rounded-xs bg-white mb-7'></div>
                        <div className='w-[100px] h-[100px] rounded-xs bg-white'></div>
                    </div>
            </div>
            <div>
                <h1 className='header text-[240px] font-extrabold scale-0'>BrainFlip</h1>
            </div>
